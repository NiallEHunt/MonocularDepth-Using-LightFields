...
def parse_args():
    ...
    parser.add_argument('--output_path', type=str,
                        help='path to the output folder for the test images', required=True)
...
def test_simple(args):
    ...
    with torch.no_grad():
        for idx, image_path in enumerate(paths):
            ...
            np.save(name_dest_npy, disp_resized_np)
            ...
            name_dest_im = os.path.join(output_directory, f'{output_name}.png')
            im.save(name_dest_im)

            with open(f'{output_directory}/{output_name}.txt', 'w') as f:
